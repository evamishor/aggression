...
%     moviename = [];
%     theanswer = input('Serious orcool? Type s or c [s/c]? ', 's');
% end;

%if isempty(moviename)
   % moviename = 'Untitled.mp4';
%end
...
%         moviefiles(end).credits = 'FOSDEM 2012 talk about Linux''s next generation graphics display server "Wayland"';
        ...
        moviefiles(end+1).name = 'https://r1---sn-h5jic5-ua8e.googlevideo.com/videoplayback?pl=16&ip=132.76.10.42&ei=m62pV62RHKK7iQaHn5m4BQ&ms=au&mt=1470737280&mv=m&id=o-ADh85b-SZX8-Kp4NljY3FF8nOU80o7uyao46FcFV5r_9&mm=31&mn=sn-h5jic5-ua8e&sver=3&upn=NbrlJz93NGg&expire=1470759419&itag=18&ratebypass=yes&requiressl=yes&lmt=1401929365586380&source=youtube&dur=721.467&key=yt6&signature=20F954C81649A5D4F93394DB10A9808B2F65C3DD.2EBA6C6E9DD68F64B0A4A5131BC82E002150BA6D&fexp=9422596%2C9428398%2C9431012%2C9433096%2C9433223%2C9433946%2C9435526%2C9437552%2C9438327%2C9438662%2C9438805%2C9439580%2C9442424&mime=video%2Fmp4&sparams=dur%2Cei%2Cid%2Cinitcwndbps%2Cip%2Cipbits%2Citag%2Clmt%2Cmime%2Cmm%2Cmn%2Cms%2Cmv%2Cpl%2Cratebypass%2Crequiressl%2Csource%2Cupn%2Cexpire&ipbits=0&initcwndbps=10525000';
        moviefiles(end).url = 'https://www.youtube.com/watch?v=FfkcCCfNBHk';
